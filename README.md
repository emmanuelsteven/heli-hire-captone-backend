...
<div align="center">
  <br/>
  <h1><b>HeliHire Backend 🏠️🛠️</b></h1>
</div>
...
# 📖 HeliHire-Backend <a name="about-project"></a> <a name="about-project"></a>

**HeliHire** is a Rails project which provides the API for the HeliHire Frontend.
...
```sh
   git clone https://github.com/emmanuelsteven/heli-hire-captone-backend
```

- Navigate into the cloned folder

```sh
cd heli-hire-captone-backend
```
...
Feel free to check the [issues page](https://github.com/emmanuelsteven/heli-hire-captone-backend/issues).
